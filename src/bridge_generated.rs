...
fn wire_program_uncurry_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, UncurriedProgramToDart>(
        WrapInfo {
...
fn wire_program_disassemble_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || {
            ...
            move |task_callback| Ok(program_disassemble(api_ser_program_bytes, api_version))
        },
    )
}
fn wire_program_run_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ApiOutputProgram>(
        WrapInfo {
