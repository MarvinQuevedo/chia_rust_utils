...
fn wire_secret_key_from_seed_impl(port_: MessagePort, seed: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| Ok::<_, ()>(secret_key_from_seed(api_seed))
        },
    )
}
fn wire_secret_key_public_key_impl(port_: MessagePort, sk: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(secret_key_public_key(api_sk)) }
        },
    )
}
fn wire_secret_key_derive_path_hardened_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(secret_key_derive_path_hardened(api_sk, api_path))
            }
        },
    )
}
fn wire_secret_key_derive_path_unhardened_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            let api_path = path.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(secret_key_derive_path_unhardened(api_sk, api_path))
            }
        },
    )
}
fn wire_public_key_derive_path_unhardened_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            let api_path = path.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(public_key_derive_path_unhardened(api_sk, api_path))
            }
        },
    )
}
fn wire_signature_sign_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(signature_sign(api_sk, api_msg)) }
        },
    )
}
fn wire_signature_is_valid_impl(port_: MessagePort, sig: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<bool, ()> { Ok(signature_is_valid(api_sig)) }
        },
    )
}
fn wire_signature_aggregate_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(signature_aggregate(api_sigs_stream, api_length))
            }
        },
    )
}
fn wire_signature_verify_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, bool, _>(
        ...
        move || {
            ...
            let api_msg = msg.wire2api();
            let api_sig = sig.wire2api();
            move |task_callback| -> Result<bool, ()> {
                Ok(signature_verify(api_pk, api_msg, api_sig))
            }
        },
    )
}
fn wire_pub_mnemonic_to_entropy_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(pub_mnemonic_to_entropy(api_mnemonic_words))
            }
        },
    )
}
fn wire_pub_entropy_to_mnemonic_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<String, ()> { Ok(pub_entropy_to_mnemonic(api_entropy)) }
        },
    )
}
fn wire_pub_entropy_to_seed_impl(port_: MessagePort, entropy: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_entropy = entropy.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(pub_entropy_to_seed(api_entropy)) }
        },
    )
}
fn wire_bytes_to_hex_impl(port_: MessagePort, bytes: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<String, ()> { Ok(bytes_to_hex(api_bytes)) }
        },
    )
}
fn wire_hex_to_bytes_impl(port_: MessagePort, hex: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(hex_to_bytes(api_hex)) }
        },
    )
}
fn wire_bytes_to_sha256_impl(port_: MessagePort, bytes: impl Wire2Api<Vec<u8>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_bytes = bytes.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(bytes_to_sha256(api_bytes)) }
        },
    )
}
fn wire_pub_master_to_wallet_unhardened_intermediate_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(pub_master_to_wallet_unhardened_intermediate(api_master))
            }
        },
    )
}
fn wire_pub_master_to_wallet_unhardened_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(pub_master_to_wallet_unhardened(api_master, api_idx))
            }
        },
    )
}
fn wire_pub_master_to_wallet_hardened_intermediate_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_master = master.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(pub_master_to_wallet_hardened_intermediate(api_master))
            }
        },
    )
}
fn wire_pub_master_to_wallet_hardened_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            let api_idx = idx.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(pub_master_to_wallet_hardened(api_master, api_idx))
            }
        },
    )
}
...
fn wire_cmds_program_run_impl(port_: MessagePort, args: impl Wire2Api<Vec<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<String, ()> { Ok(cmds_program_run(api_args)) }
        },
    )
}
fn wire_cmds_program_brun_impl(port_: MessagePort, args: impl Wire2Api<Vec<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            let api_args = args.wire2api();
            move |task_callback| -> Result<String, ()> { Ok(cmds_program_brun(api_args)) }
        },
    )
}
fn wire_cmd_program_opc_impl(port_: MessagePort, args: impl Wire2Api<Vec<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<String>, _>(
        ...
        move || {
            let api_args = args.wire2api();
            move |task_callback| -> Result<Vec<String>, ()> { Ok(cmd_program_opc(api_args)) }
        },
    )
}
fn wire_cmd_program_opd_impl(port_: MessagePort, args: impl Wire2Api<Vec<String>> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<String>, _>(
        ...
        move || {
            let api_args = args.wire2api();
            move |task_callback| -> Result<Vec<String>, ()> { Ok(cmd_program_opd(api_args)) }
        },
    )
}
fn wire_program_tree_hash_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, [u8; 32], _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<[u8; 32], ()> {
                Ok(program_tree_hash(api_ser_program_bytes))
            }
        },
    )
}
fn wire_program_curry_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(program_curry(api_ser_program_bytes, api_args_str))
            }
        },
    )
}
fn wire_program_uncurry_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, UncurriedProgramToDart, _>(
        WrapInfo {
        ...
        move || {
            let api_ser_program_bytes = ser_program_bytes.wire2api();
            move |task_callback| -> Result<UncurriedProgramToDart, ()> {
                Ok(program_uncurry(api_ser_program_bytes))
            }
        },
    )
}
fn wire_program_from_list_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(program_from_list(api_program_list)) }
        },
    )
}
fn wire_program_disassemble_impl(
    port_: MessagePort,
    ser_program_bytes: impl Wire2Api<Vec<u8>> + UnwindSafe,
    version: impl Wire2Api<Option<usize>> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        WrapInfo {
        ...
        move || {
            ...
            move |task_callback| -> Result<String, ()> {
                Ok(program_disassemble(api_ser_program_bytes, api_version))
            }
        },
    )
}
fn wire_program_run_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ApiOutputProgram, _>(
        WrapInfo {
        ...
        move || {
            let api_ser_program_bytes = ser_program_bytes.wire2api();
            let api_args_str = args_str.wire2api();
            move |task_callback| -> Result<ApiOutputProgram, ()> {
                Ok(program_run(api_ser_program_bytes, api_args_str))
            }
        },
    )
}
fn wire_program_from_atom_bytes_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_ser_program_bytes = ser_program_bytes.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(program_from_atom_bytes(api_ser_program_bytes))
            }
        },
    )
}
fn wire_program_to_atom_bytes_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_ser_program_bytes = ser_program_bytes.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(program_to_atom_bytes(api_ser_program_bytes))
            }
        },
    )
}
fn wire_get_puzzle_from_public_key_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            let api_pk = pk.wire2api();
            move |task_callback| -> Result<Vec<u8>, ()> { Ok(get_puzzle_from_public_key(api_pk)) }
        },
    )
}
fn wire_cats_create_cat_puzzle_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<u8>, _>(
        ...
        move || {
            ...
            move |task_callback| -> Result<Vec<u8>, ()> {
                Ok(cats_create_cat_puzzle(api_tail_hash, api_inner_puzzle_hash))
            }
        },
    )
}
...
impl rust2dart::IntoIntoDart<ApiOutputProgram> for ApiOutputProgram {
...
impl rust2dart::IntoIntoDart<UncurriedProgramToDart> for UncurriedProgramToDart {
    fn into_into_dart(self) -> Self {
        self
    }
}
